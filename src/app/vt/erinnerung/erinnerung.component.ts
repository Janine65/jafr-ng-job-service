...
import { ERINNERUNG_COLUMNS, ERINNERUNG_EXAMPLE_SHEET } from './erinnerung.tables';
...
@Component({
    ...
    templateUrl: './erinnerung.component.html'
})
export class ErinnerungComponent implements OnInit, OnDestroy {
    private excelService = inject(ExcelService);
    private translate = inject(TranslateService);
    private jobService = inject(ErinnerungService);
    private logger = inject(LogFactoryService).createLogger('ErinnerungComponent');
    ...
    excelColumns = ERINNERUNG_COLUMNS;

    // Progress list configuration
    progressListConfig = VT_DEFAULT_PROGRESS_CONFIG;

    ngOnInit(): void {
        this.logger.debug('Initializing ErinnerungComponent');
        ...
        this.logger.debug('ErinnerungComponent initialization complete');
    }

    ngOnDestroy(): void {
        this.logger.debug('Destroying ErinnerungComponent');
    }
    ...
    async onFileSelected(file: File): Promise<void> {
        ...
        this.isLoading = true;
        // Immediately show spinner for running jobs list
    ...
    createExampleSheet(): void {
        ...
        this.exampleSheetHtml = this.excelService.createStyledPreview(ERINNERUNG_EXAMPLE_SHEET, 'Erinnerung');
    }
    ...
    downloadExampleSheet(): void {
        ...
        this.excelService.downloadExcelFile(ERINNERUNG_EXAMPLE_SHEET, 'erinnerung_beispiel', 'Erinnerung');
