...
import { AUFGABE_COLUMNS, AUFGABE_EXAMPLE_SHEET } from './aufgabe.tables';
...
export class AufgabeComponent implements OnInit, OnDestroy {
    private excelService = inject(ExcelService);
    private translate = inject(TranslateService);
    private jobService = inject(AufgabeService);
    private logger = inject(LogFactoryService).createLogger('AufgabeComponent');
    ...
    excelColumns = AUFGABE_COLUMNS;

    // Progress list configuration
    progressListConfig = VT_DEFAULT_PROGRESS_CONFIG;

    ngOnInit(): void {
        this.logger.debug('Initializing AufgabeComponent');
        ...
        this.logger.debug('AufgabeComponent initialization complete');
    }

    ngOnDestroy(): void {
        this.logger.debug('Destroying AufgabeComponent');
    }
    ...
    async onFileSelected(file: File): Promise<void> {
        ...
        this.isLoading = true;
        // Immediately show spinner so user sees activity in running jobs
    ...
    createExampleSheet(): void {
        ...
        this.exampleSheetHtml = this.excelService.createStyledPreview(AUFGABE_EXAMPLE_SHEET, 'Aufgabe');
    }
    ...
    downloadExampleSheet(): void {
        ...
        this.excelService.downloadExcelFile(AUFGABE_EXAMPLE_SHEET, 'aufgabe_beispiel', 'Aufgabe');
